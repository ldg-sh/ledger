    ...
    pub async fn list_files(
        ...
        let parsed: Vec<TFileInfo> = objs
            ...
            .filter_map(|obj| {
                ...
                let last_modified = aws_dt.to_string().parse::<ChronoDateTime<Utc>>().ok()?;
        ...
        let next_cursor = objs.next_continuation_token.map(|s| s.to_string());
